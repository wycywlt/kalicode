...
sleep(1)
#3.定位到指定标签填充用户名和密码
user_box = bro.find_element(By.XPATH, '//*[@id="app"]/div[2]/div[2]/div[3]/div[2]/div[1]/div[1]/input')
user_box.send_keys('15027900535')
sleep(1)
pwd_box = bro.find_element(By.XPATH, '//*[@id="app"]/div[2]/div[2]/div[3]/div[2]/div[1]/div[3]/input')
pwd_box.send_keys('123456')
sleep(1)
login_btn = bro.find_element(By.XPATH, '//*[@id="app"]/div[2]/div[2]/div[3]/div[2]/div[2]/div[2]')
login_btn.click()
sleep(10)
#4.定位完整的验证码对话框
#注意：在开发者工具中是可以定位到多个div表示验证码对话框的，因此将这几个div都定位到，以此去尝试
code_tag = bro.find_element(By.XPATH, '/html/body/div[4]/div[2]/div[6]/div/div')
sleep(1)
...
sleep(2)
#此处使用class属性进行确定标签定位
confirm_btn = bro.find_element(By.XPATH, '//a[@class="geetest_commit"]')
confirm_btn.click()
sleep(3)
bro.quit()
